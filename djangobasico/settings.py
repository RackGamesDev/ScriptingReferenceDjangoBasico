...
SECRET_KEY = 'django-insecure-qy$e3qqzm!jk7^6pw8jm(eul(+&^9-tch!=49$-b00ll6gj&d6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*f'] #'*' para el hosting
...
#datos por defecto para conectar con sqlite3 (db.sqlite3)
    #'default': {
